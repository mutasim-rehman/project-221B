...
import './App.css'
import { fetchCaseStory, fetchCharacterReply, fetchChatroomTurn } from './api'
      ...
      <div className="archive-inner archive-inner--chat">
        <aside className="sidebar-card" aria-label="Character details">
          ...
          <div className="sidebar-note">
            Messages are rendered as dated entries in a private case journal. Replies are
            generated in character, grounded in canon passages from the RAG backend.
          </div>
        </aside>
